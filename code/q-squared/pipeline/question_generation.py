...
def get_questions_beam(answer, context, max_length=128, beam_size=5, num_return=5):
    ...
    beam_outputs = qg_model.generate(input_ids=features['input_ids'].to("cuda:0"), attention_mask=features['attention_mask'].to("cuda:0"),
...
def get_questions_sample(answer, context, max_length=128, top_k=50, top_p=0.95, num_return=5):
    ...
    sampled_outputs = qg_model.generate(input_ids=features['input_ids'].to("cuda:0"), attention_mask=features['attention_mask'].to("cuda:0"),
